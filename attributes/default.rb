# General settings
default[:magento][:download_url] = "http://www.magentocommerce.com/downloads/assets/1.8.1.0/magento-1.8.1.0.tar.gz"
...
default[:magento][:use_rewrites] = "no"
...
default[:apache][:default_modules] = %w[ status actions alias auth_basic authn_file authz_default authz_groupfile authz_host authz_user autoindex dir env mime negotiation setenvif ssl headers expires log_config logio fastcgi]
default['apache']['mod_ssl']['cipher_suite'] = 'ALL:!ADH:RC4+RSA:+HIGH:+MEDIUM:!LOW:!SSLv2:!EXPORT'
